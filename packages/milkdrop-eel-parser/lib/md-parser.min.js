...
"abs","abs",-246026477),Mm,new Q(null,"sin","sin",80907862),new Q(null,"bor","bor",-1186222282),new Q(null,"sigmoid","sigmoid",-935420808),new Q(null,"equal","equal",-1921681350),new Q(null,"above","above",-1286866470),new Q(null,"acos","acos",-1286789764),new Q(null,"log","log",-1595516004),new Q(null,"below","below",-926774883),new Q(null,"floor","floor",1882041021),new Q(null,"atan2","atan2",-1775503683)],"Math.min Math.atan sign Math.cos log10 Math.tan Math.trunc rand bnot sqrt pow Math.exp band sqr Math.asin Math.abs Math.max Math.sin bor sigmoid equal above Math.acos Math.log below Math.floor Math.atan2".split(" ")),
