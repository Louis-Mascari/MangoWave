...
export default class WarpShader {
  ...
  createShader(shaderText = '', _fallback = false) {
    ...
    const fragOk = _mwCheckShader(this.gl, fragShader, 'Warp fragment');
  ...
  renderQuadTexture(
    ...
    this.gl.bufferData(this.gl.ARRAY_BUFFER, warpUVs, this.gl.DYNAMIC_DRAW);
    ...
    this.gl.bufferData(this.gl.ARRAY_BUFFER, warpColor, this.gl.DYNAMIC_DRAW);
