...
- **Visual quality controls** — mesh resolution, texture quality, FXAA anti-aliasing, FPS cap, resolution scaling, FFT size, smoothing, and auto quality (runtime FPS monitoring that automatically steps between 5 quality tiers from Minimum to Ultra)
