!(function (t, e) {
  'object' == typeof exports && 'object' == typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define('butterchurn', [], e)
      : 'object' == typeof exports
        ? (exports.butterchurn = e())
        : (t.butterchurn = e());
})(window, function () {
  return (function (t) {
    var e = {};
        ...
        (s = function () {
          return {
            ...
            frame_eqs: function (t) {
              return (
                (t.rkeys = ['warp']),
                (t.zoom = 1.01 + 0.02 * t.treb_att),
                (t.warp = 0.15 + 0.25 * t.bass_att),
                t
              );
            },
    ...
    function (t, e) {
      ((window.sqr = function (t) {
        ...
        (window.ifcond = function (t, e, i) {
          return Math.abs(t) > 1e-5 ? e : i;
        }),
    ...
    function (t, e, i) {
          ...
          (i = [
            {
              ...
              value: function () {
                ...
                for (
                  var t = 1 / this.samplesOut, e = 0;
                  e < this.samplesOut;
                  e++
                )
                  this.equalizeArr[e] =
                    -0.02 * Math.log((this.samplesOut - e) * t);
              },
            },
            {
              key: 'initBitRevTable',
              value: function () {
                ...
                for (var e = 0, i = 0; i < this.NFREQ; i++) {
                  if (e > i) {
                    ...
                    ((this.bitrevtable[i] = this.bitrevtable[e]),
                      (this.bitrevtable[e] = s));
                  }
                  for (var r = this.NFREQ >> 1; r >= 1 && e >= r; )
                    ((e -= r), (r >>= 1));
                  e += r;
                }
              },
            },
            {
              ...
              value: function () {
                ...
                for (var i = 0; t <= this.NFREQ; ) {
                  var s = (-2 * Math.PI) / t;
                  ((this.cossintable[0][i] = Math.cos(s)),
                    (this.cossintable[1][i] = Math.sin(s)),
                    (i += 1),
                    (t <<= 1));
                }
              },
            },
            {
              ...
              value: function (t) {
                for (
                  var e = new Float32Array(this.NFREQ),
                    i = new Float32Array(this.NFREQ),
                    s = 0;
                  s < this.NFREQ;
                  s++
                ) {
                ...
                for (var a = 2, h = 0; a <= this.NFREQ; ) {
                  for (
                    var o = this.cossintable[0][h],
                      n = this.cossintable[1][h],
                      l = 1,
                      m = 0,
                      u = a >> 1,
                      g = 0;
                ...
                if (this.equalize)
                  for (var _ = 0; _ < this.samplesOut; _++)
                    p[_] =
                      this.equalizeArr[_] *
                      Math.sqrt(e[_] * e[_] + i[_] * i[_]);
                else
                  for (var x = 0; x < this.samplesOut; x++)
                    p[x] = Math.sqrt(e[x] * e[x] + i[x] * i[x]);
                return p;
              },
            },
          ]) && s(e.prototype, i),
          ...
          (i = [
            ...
            },
            {
              ...
              value: function (t, e, i) {
                (this.timeByteArray.set(t),
                  this.timeByteArrayL.set(e),
                  this.timeByteArrayR.set(i),
                  this.processAudio());
              },
            },
            {
              key: 'processAudio',
              value: function () {
                for (var t = 0, e = 0, i = 0; t < this.fftSize; t++)
                  ((this.timeArray[t] = this.timeByteArray[t] - 128),
                    (this.timeByteArraySignedL[t] =
                      this.timeByteArrayL[t] - 128),
                    (this.timeByteArraySignedR[t] =
                      this.timeByteArrayR[t] - 128),
                    (this.tempTimeArrayL[t] =
                      0.5 *
                      (this.timeByteArraySignedL[t] +
                        this.timeByteArraySignedL[i])),
                    (this.tempTimeArrayR[t] =
                      0.5 *
                      (this.timeByteArraySignedR[t] +
                        this.timeByteArraySignedR[i])),
                    t % 2 == 0 &&
                      ((this.timeArrayL[e] = this.tempTimeArrayL[t]),
                      (this.timeArrayR[e] = this.tempTimeArrayR[t]),
                      (e += 1)),
                    (i = t));
                ((this.freqArray = this.fft.timeToFrequencyDomain(
                  this.timeArray,
                )),
          ...
          function t(e) {
            ...
            var i =
                (this.audio.audioContext
                  ? this.audio.audioContext.sampleRate
                  : 44100) / this.audio.fftSize,
              s = Math.clamp(
                Math.round(20 / i) - 1,
                0,
            ...
            (i = [
              {
                ...
                value: function (e, i) {
                  if (this.audio.freqArray.length > 0) {
                    var s = e;
                    (!t.isFiniteNumber(s) || s < 15
                      ? (s = 15)
                      : s > 144 && (s = 144),
                      this.imm.fill(0));
                    for (var r = 0; r < 3; r++)
                      for (var a = this.starts[r]; a < this.stops[r]; a++)
                        this.imm[r] += this.audio.freqArray[a];
                    for (var h = 0; h < 3; h++) {
                      var o = void 0;
                      ((o = this.imm[h] > this.avg[h] ? 0.2 : 0.5),
                        (o = t.adjustRateToFPS(o, 30, s)),
                        (this.avg[h] = this.avg[h] * o + this.imm[h] * (1 - o)),
                        (o = i < 50 ? 0.9 : 0.992),
                        (o = t.adjustRateToFPS(o, 30, s)),
                        (this.longAvg[h] =
                          this.longAvg[h] * o + this.imm[h] * (1 - o)),
                        this.longAvg[h] < 0.001
                          ? ((this.val[h] = 1), (this.att[h] = 1))
                          : ((this.val[h] = this.imm[h] / this.longAvg[h]),
                            (this.att[h] = this.avg[h] / this.longAvg[h])));
                    }
                  }
                },
              },
        ...
        return (
          ...
          (s = [
            ...
            },
            {
              key: 'omit',
              value: function (t, e) {
                for (var i = Object.assign({}, t), s = 0; s < e.length; s++) {
                  delete i[e[s]];
                }
                return i;
              },
      ...
      var f = (function () {
        function t(e, i, s) {
          (!(function (t, e) {
            ...
            (this.qs = c.range(1, 33).map(function (t) {
              return 'q'.concat(t);
            })),
            (this.ts = c.range(1, 9).map(function (t) {
              return 't'.concat(t);
            })),
            (this.regs = c.range(100).map(function (t) {
          ...
          (i = [
            {
              ...
              value: function (t) {
                ...
                var i = this.qs.concat(this.regs, Object.keys(this.mdVS)),
                  s = this.preset.init_eqs(c.cloneVars(this.mdVS));
                ((this.mdVSQInit = c.pick(s, this.qs)),
                  (this.mdVSRegs = c.pick(s, this.regs)));
                var r = c.pick(s, Object.keys(c.omit(s, i)));
                if (
                  ((r.megabuf = s.megabuf),
                  (r.gmegabuf = s.gmegabuf),
                  ...
                  (this.mdVSUserKeys = Object.keys(c.omit(this.mdVSFrame, i))),
                  (this.mdVSFrameMap = c.pick(
                    this.mdVSFrame,
                    this.mdVSUserKeys,
                  )),
                  (this.mdVSQAfterFrame = c.pick(this.mdVSFrame, this.qs)),
                  (this.mdVSRegs = c.pick(this.mdVSFrame, this.regs)),
                  (this.mdVSWaves = []),
                  (this.mdVSTWaveInits = []),
                  ...
                  for (var a = 0; a < this.preset.waves.length; a++) {
                    var h = this.preset.waves[a],
                      o = h.baseVals;
                    if (0 !== o.enabled) {
                      var n = Object.assign({}, o, e),
                        l = this.qs.concat(this.ts, this.regs, Object.keys(n));
                      (Object.assign(n, this.mdVSQAfterFrame, this.mdVSRegs),
                        (n.megabuf = new Array(1048576).fill(0)),
                        h.init_eqs &&
                          ((n = h.init_eqs(n)),
                          (this.mdVSRegs = c.pick(n, this.regs)),
                          Object.assign(n, o)),
                        this.mdVSWaves.push(n),
                        this.mdVSTWaveInits.push(c.pick(n, this.ts)),
                        this.mdVSUserKeysWaves.push(Object.keys(c.omit(n, l))),
                        this.mdVSFrameMapWaves.push(
                          c.pick(n, this.mdVSUserKeysWaves[a]),
                        ));
                    } else
                      (this.mdVSWaves.push({}),
                ...
                if (
                  ...
                  for (var m = 0; m < this.preset.shapes.length; m++) {
                    var u = this.preset.shapes[m],
                      g = u.baseVals;
                    if (0 !== g.enabled) {
                      var A = Object.assign({}, g, e),
                        f = this.qs.concat(this.ts, this.regs, Object.keys(A));
                      (Object.assign(A, this.mdVSQAfterFrame, this.mdVSRegs),
                        (A.megabuf = new Array(1048576).fill(0)),
                        u.init_eqs &&
                          ((A = u.init_eqs(A)),
                          (this.mdVSRegs = c.pick(A, this.regs)),
                          Object.assign(A, g)),
                        this.mdVSShapes.push(A),
                        this.mdVSTShapeInits.push(c.pick(A, this.ts)),
                        this.mdVSUserKeysShapes.push(Object.keys(c.omit(A, f))),
                        this.mdVSFrameMapShapes.push(
                          c.pick(A, this.mdVSUserKeysShapes[m]),
                        ));
                    } else
      ...
      var v = /uniform sampler2D sampler_(?:.+?);/g,
        p = /uniform sampler2D sampler_(.+?);/,
        _ = (function () {
          function t() {
            !(function (t, e) {
              if (!(t instanceof e))
      ...
      function _mwCheckShader(gl, shader, label) {
        if (!gl.getShaderParameter(shader, gl.COMPILE_STATUS)) {
          ...
          console.error('[butterchurn] ' + label + ' compile failed:', log);
          return false;
        }
        return true;
      }
      function _mwCheckProgram(gl, program, label) {
        if (!gl.getProgramParameter(program, gl.LINK_STATUS)) {
          var log = gl.getProgramInfoLog(program);
          console.error('[butterchurn] ' + label + ' link failed:', log);
          return false;
        }
        return true;
      }
          ...
          (s = [
            {
              ...
              value: function (t, e, i) {
                for (
                  ...
                  ((s = o), (o = Math.min(i - 1, n + 2)));
                  for (var l = 0; l < 3; l++) e[3 * a + l] = t[3 * n + l];
                  if (r)
                    for (var m = 0; m < 3; m++)
                      e[3 * (a + 1) + m] =
                        0.5 *
                ...
                for (var g = 0; g < 3; g++) e[3 * a + g] = t[3 * (i - 1) + g];
              },
            },
            {
              ...
              value: function (t, e, i, s, r) {
                for (
                  ...
                  ((a = l), (l = Math.min(r - 1, m + 2)));
                  for (var u = 0; u < 3; u++) i[3 * o + u] = t[3 * m + u];
                  if (h)
                    for (var g = 0; g < 3; g++)
                      i[3 * (o + 1) + g] =
                        0.5 *
                ...
                for (var f = 0; f < 3; f++) i[3 * o + f] = t[3 * (r - 1) + f];
                for (var d = 0; d < 4; d++) s[4 * o + d] = e[4 * (r - 1) + d];
              },
            },
          ]),
          (i = null) && x(e.prototype, i),
          s && x(e, s),
          t
        );
      })();
      ...
      var E = (function () {
        function t(e) {
          ...
          ((this.positions = new Float32Array(1536)),
            ...
            (this.invAspectx = 1 / this.aspectx),
            (this.invAspecty = 1 / this.aspecty),
            (this.floatPrecision = _.getFragmentFloatPrecision(this.gl)),
            this.createShader(),
          ...
          (i = [
            ...
            },
            {
              ...
              value: function () {
                ...
                (this.gl.shaderSource(
                  ...
                  (this.aPosLoc = this.gl.getAttribLocation(
                    this.shaderProgram,
                    'aPos',
                  )),
                  (this.colorLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'u_color',
                  )),
            ...
            },
            {
              ...
              value: function (e, i, s, r, a) {
                var h = a.wave_a,
                  o = (a.bass + a.mid + a.treb) / 3;
                if (o > -0.01 && h > 0.001 && s.length > 0) {
                  var n = t.processWaveform(s, a),
                    l = t.processWaveform(r, a),
                    m = Math.floor(a.wave_mode) % 8,
                    u = Math.floor(a.old_wave_mode) % 8,
                    g = 2 * a.wave_x - 1,
                    c = 2 * a.wave_y - 1;
                  ((this.numVert = 0), (this.oldNumVert = 0));
                  for (var A = e && m !== u ? 2 : 1, f = 0; f < A; f++) {
                    var d = 0 === f ? m : u,
                      v = a.wave_mystery;
                    (0 !== d && 1 !== d && 4 !== d) ||
                      !(v < -1 || v > 1) ||
                    ...
                    if (
                      (0 === f
                        ? ((_ = this.positions), (x = this.positions2))
                        : ((_ = this.oldPositions), (x = this.oldPositions2)),
                      (h = a.wave_a),
                      0 === d)
                    ) {
                      if (a.modwavealphabyvolume > 0) {
                        var T = a.modwavealphaend - a.modwavealphastart;
                        h *= (o - a.modwavealphastart) / T;
                      }
                      h = Math.clamp(h, 0, 1);
                      for (
                        var E = 1 / ((p = Math.floor(n.length / 2) + 1) - 1),
                          P = Math.floor((n.length - p) / 2),
                          R = 0;
                        R < p - 1;
                        R++
                      ) {
                        var L = 0.5 + 0.4 * l[R + P] + v,
                          S = R * E * 2 * Math.PI + 0.2 * a.time;
                        if (R < p / 10) {
                          var y = R / (0.1 * p);
                          L =
                            (1 - (y = 0.5 - 0.5 * Math.cos(y * Math.PI))) *
                              (0.5 + 0.4 * l[R + p + P] + v) +
                            L * y;
                        }
                        ((_[3 * R + 0] = L * Math.cos(S) * this.aspecty + g),
                          (_[3 * R + 1] = L * Math.sin(S) * this.aspectx + c),
                          (_[3 * R + 2] = 0));
                      }
                      ((_[3 * (p - 1) + 0] = _[0]),
                        (_[3 * (p - 1) + 1] = _[1]),
                      ...
                      if (((h *= 1.25), a.modwavealphabyvolume > 0)) {
                        var w = a.modwavealphaend - a.modwavealphastart;
                        h *= (o - a.modwavealphastart) / w;
                      }
                      ((h = Math.clamp(h, 0, 1)),
                        (p = Math.floor(n.length / 2)));
                      for (var U = 0; U < p; U++) {
                        var M = 0.53 + 0.43 * l[U] + v,
                          F = 0.5 * n[U + 32] * Math.PI + 2.3 * a.time;
                        ((_[3 * U + 0] = M * Math.cos(F) * this.aspecty + g),
                          (_[3 * U + 1] = M * Math.sin(F) * this.aspectx + c),
                          (_[3 * U + 2] = 0));
                      }
                    } else if (2 === d) {
                      if (
                        (this.texsizeX < 1024
                          ? (h *= 0.09)
                          : this.texsizeX >= 1024 && this.texsizeX < 2048
                            ? (h *= 0.11)
                            : (h *= 0.13),
                        a.modwavealphabyvolume > 0)
                      ) {
                        var q = a.modwavealphaend - a.modwavealphastart;
                        h *= (o - a.modwavealphastart) / q;
                      }
                      ((h = Math.clamp(h, 0, 1)), (p = n.length));
                      for (var z = 0; z < n.length; z++)
                        ((_[3 * z + 0] = l[z] * this.aspecty + g),
                          (_[3 * z + 1] =
                            n[(z + 32) % n.length] * this.aspectx + c),
                          (_[3 * z + 2] = 0));
                    } else if (3 === d) {
                      if (
                        (this.texsizeX < 1024
                        ...
                        var B = a.modwavealphaend - a.modwavealphastart;
                        h *= (o - a.modwavealphastart) / B;
                      }
                      ((h = Math.clamp(h, 0, 1)), (p = n.length));
                      for (var C = 0; C < n.length; C++)
                        ((_[3 * C + 0] = l[C] * this.aspecty + g),
                          (_[3 * C + 1] =
                            n[(C + 32) % n.length] * this.aspectx + c),
                          (_[3 * C + 2] = 0));
                    } else if (4 === d) {
                      if (a.modwavealphabyvolume > 0) {
                        var D = a.modwavealphaend - a.modwavealphastart;
                        h *= (o - a.modwavealphastart) / D;
                      }
                      ((h = Math.clamp(h, 0, 1)),
                        (p = n.length) > this.texsizeX / 3 &&
                          (p = Math.floor(this.texsizeX / 3)));
                      for (
                        var V = 1 / p,
                          I = Math.floor((n.length - p) / 2),
                          X = 0.45 + 0.5 * (0.5 * v + 0.5),
                          k = 1 - X,
                          N = 0;
                        N < p;
                        N++
                        ...
                        var O =
                            2 * N * V +
                            (g - 1) +
                            0.44 * l[(N + 25 + I) % n.length],
                          W = 0.47 * n[N + I] + c;
                        (N > 1 &&
                          ((O =
                            O * k +
                            X * (2 * _[3 * (N - 1) + 0] - _[3 * (N - 2) + 0])),
                          (W =
                            W * k +
                            X * (2 * _[3 * (N - 1) + 1] - _[3 * (N - 2) + 1]))),
                          (_[3 * N + 0] = O),
                          (_[3 * N + 1] = W),
                          (_[3 * N + 2] = 0));
                      }
                      ...
                      h = Math.clamp(h, 0, 1);
                      var Y = Math.cos(0.3 * a.time),
                        G = Math.sin(0.3 * a.time);
                      p = n.length;
                      for (var H = 0; H < n.length; H++) {
                        var j = (H + 32) % n.length,
                          K = l[H] * n[j] + n[H] * l[j],
                          J = l[H] * l[H] - n[j] * n[j];
                        ((_[3 * H + 0] = (K * Y - J * G) * (this.aspecty + g)),
                          (_[3 * H + 1] = (K * G + J * Y) * (this.aspectx + c)),
                          (_[3 * H + 2] = 0));
                      }
                    } else if (6 === d || 7 === d) {
                      if (a.modwavealphabyvolume > 0) {
                        var Z = a.modwavealphaend - a.modwavealphastart;
                        h *= (o - a.modwavealphastart) / Z;
                      }
                      ((h = Math.clamp(h, 0, 1)),
                        (p = Math.floor(n.length / 2)) > this.texsizeX / 3 &&
                          (p = Math.floor(this.texsizeX / 3)));
                      for (
                        var $ = Math.floor((n.length - p) / 2),
                          tt = 0.5 * Math.PI * v,
                          et = Math.cos(tt),
                          it = Math.sin(tt),
                          st = [
                            g * Math.cos(tt + 0.5 * Math.PI) - 3 * et,
                            g * Math.cos(tt + 0.5 * Math.PI) + 3 * et,
                          ],
                          rt = [
                            g * Math.sin(tt + 0.5 * Math.PI) - 3 * it,
                            g * Math.sin(tt + 0.5 * Math.PI) + 3 * it,
                          ],
                          at = 0;
                        at < 2;
                      ...
                      ((et = (st[1] - st[0]) / p), (it = (rt[1] - rt[0]) / p));
                      var ut = Math.atan2(it, et),
                        gt = Math.cos(ut + 0.5 * Math.PI),
                        ct = Math.sin(ut + 0.5 * Math.PI);
                      if (6 === d)
                        for (var At = 0; At < p; At++) {
                          var ft = n[At + $];
                          ((_[3 * At + 0] = st[0] + et * At + 0.25 * gt * ft),
                            (_[3 * At + 1] = rt[0] + it * At + 0.25 * ct * ft),
                            (_[3 * At + 2] = 0));
                        }
                      else if (7 === d) {
                        for (
                          var dt = Math.pow(0.5 * c + 0.5, 2), vt = 0;
                          vt < p;
                          vt++
                        ) {
                          var pt = n[vt + $];
                          ((_[3 * vt + 0] =
                            st[0] + et * vt + gt * (0.25 * pt + dt)),
                            (_[3 * vt + 1] =
                              rt[0] + it * vt + ct * (0.25 * pt + dt)),
                            (_[3 * vt + 2] = 0));
                        }
                        for (var _t = 0; _t < p; _t++) {
                          var xt = l[_t + $];
                          ((x[3 * _t + 0] =
                            st[0] + et * _t + gt * (0.25 * xt - dt)),
                            (x[3 * _t + 1] =
                              rt[0] + it * _t + ct * (0.25 * xt - dt)),
                            (x[3 * _t + 2] = 0));
                        }
                      }
                    }
                    0 === f
                      ? ((this.positions = _),
                        ...
                        (this.alpha = h))
                      : ((this.oldPositions = _),
                        (this.oldPositions2 = x),
                        (this.oldNumVert = p),
                        (this.oldAlpha = h));
                  }
                  var bt = 0.5 - 0.5 * Math.cos(i * Math.PI),
                    Tt = 1 - bt;
                  this.oldNumVert > 0 &&
                    (h = bt * this.alpha + Tt * this.oldAlpha);
                  var Et = Math.clamp(a.wave_r, 0, 1),
                    Pt = Math.clamp(a.wave_g, 0, 1),
                    Rt = Math.clamp(a.wave_b, 0, 1);
                  if (0 !== a.wave_brighten) {
                    var Lt = Math.max(Et, Pt, Rt);
                    Lt > 0.01 && ((Et /= Lt), (Pt /= Lt), (Rt /= Lt));
                  }
                  if (((this.color = [Et, Pt, Rt, h]), this.oldNumVert > 0))
                    if (7 === m) {
                      for (
                        var St = (this.oldNumVert - 1) / (2 * this.numVert),
                          yt = 0;
                        yt < this.numVert;
                        yt++
                      ) {
                        var wt = yt * St,
                          ...
                          Mt = wt - Ut,
                          Ft =
                            this.oldPositions[3 * Ut + 0] * (1 - Mt) +
                            this.oldPositions[3 * (Ut + 1) + 0] * Mt,
                          qt =
                            this.oldPositions[3 * Ut + 1] * (1 - Mt) +
                            this.oldPositions[3 * (Ut + 1) + 1] * Mt;
                        ((this.positions[3 * yt + 0] =
                          this.positions[3 * yt + 0] * bt + Ft * Tt),
                          (this.positions[3 * yt + 1] =
                            this.positions[3 * yt + 1] * bt + qt * Tt),
                          (this.positions[3 * yt + 2] = 0));
                      }
                      for (var zt = 0; zt < this.numVert; zt++) {
                        var Bt = (zt + this.numVert) * St,
                          ...
                          Dt = Bt - Ct,
                          Vt =
                            this.oldPositions[3 * Ct + 0] * (1 - Dt) +
                            this.oldPositions[3 * (Ct + 1) + 0] * Dt,
                          It =
                            this.oldPositions[3 * Ct + 1] * (1 - Dt) +
                            this.oldPositions[3 * (Ct + 1) + 1] * Dt;
                        ((this.positions2[3 * zt + 0] =
                          this.positions2[3 * zt + 0] * bt + Vt * Tt),
                          (this.positions2[3 * zt + 1] =
                            this.positions2[3 * zt + 1] * bt + It * Tt),
                          (this.positions2[3 * zt + 2] = 0));
                      }
                    } else if (7 === u) {
                      for (
                        var Xt = this.numVert / 2,
                          kt = (this.oldNumVert - 1) / Xt,
                          Nt = 0;
                        Nt < Xt;
                        Nt++
                      ) {
                        var Ot = Nt * kt,
                          ...
                          Qt = Ot - Wt,
                          Yt =
                            this.oldPositions[3 * Wt + 0] * (1 - Qt) +
                            this.oldPositions[3 * (Wt + 1) + 0] * Qt,
                          Gt =
                            this.oldPositions[3 * Wt + 1] * (1 - Qt) +
                            this.oldPositions[3 * (Wt + 1) + 1] * Qt;
                        ((this.positions[3 * Nt + 0] =
                          this.positions[3 * Nt + 0] * bt + Yt * Tt),
                          (this.positions[3 * Nt + 1] =
                            this.positions[3 * Nt + 1] * bt + Gt * Tt),
                          (this.positions[3 * Nt + 2] = 0));
                      }
                      for (var Ht = 0; Ht < Xt; Ht++) {
                        var jt = Ht * kt,
                          ...
                          Jt = jt - Kt,
                          Zt =
                            this.oldPositions2[3 * Kt + 0] * (1 - Jt) +
                            this.oldPositions2[3 * (Kt + 1) + 0] * Jt,
                          $t =
                            this.oldPositions2[3 * Kt + 1] * (1 - Jt) +
                            this.oldPositions2[3 * (Kt + 1) + 1] * Jt;
                        ((this.positions2[3 * Ht + 0] =
                          this.positions[3 * (Ht + Xt) + 0] * bt + Zt * Tt),
                          (this.positions2[3 * Ht + 1] =
                            this.positions[3 * (Ht + Xt) + 1] * bt + $t * Tt),
                          (this.positions2[3 * Ht + 2] = 0));
                      }
                    } else
                      for (
                        var te = (this.oldNumVert - 1) / this.numVert, ee = 0;
                        ee < this.numVert;
                        ee++
                      ) {
                        var ie = ee * te,
                          ...
                          re = ie - se,
                          ae =
                            this.oldPositions[3 * se + 0] * (1 - re) +
                            this.oldPositions[3 * (se + 1) + 0] * re,
                          he =
                            this.oldPositions[3 * se + 1] * (1 - re) +
                            this.oldPositions[3 * (se + 1) + 1] * re;
                        ((this.positions[3 * ee + 0] =
                          this.positions[3 * ee + 0] * bt + ae * Tt),
                          (this.positions[3 * ee + 1] =
                            this.positions[3 * ee + 1] * bt + he * Tt),
                          (this.positions[3 * ee + 2] = 0));
                      }
                  for (var oe = 0; oe < this.numVert; oe++)
                    this.positions[3 * oe + 1] = -this.positions[3 * oe + 1];
                  if (
                    ((this.smoothedNumVert = 2 * this.numVert - 1),
                    b.smoothWave(
                      this.positions,
                    ...
                    for (var ne = 0; ne < this.numVert; ne++)
                      this.positions2[3 * ne + 1] =
                        -this.positions2[3 * ne + 1];
                    b.smoothWave(
                      this.positions2,
            ...
            },
            {
              ...
              value: function (t, e, i, s, r) {
                if (this.generateWaveform(t, e, i, s, r)) {
                  ...
                  var a = 1;
                  ((0 === r.wave_thick && 0 === r.wave_dots) || (a = 4),
                    0 !== r.additivewave
                  ...
                  for (
                    var h =
                        0 !== r.wave_dots ? this.gl.POINTS : this.gl.LINE_STRIP,
                      o = 0;
                    o < a;
                    o++
                  ) {
                    (0 === o
                      ...
                      this.gl.drawArrays(h, 0, this.smoothedNumVert));
                  }
      ...
      var R = (function () {
        function t(e, i, s) {
          (!(function (t, e) {
            ...
            (this.index = e),
            (this.gl = i));
          ((this.pointsData = [new Float32Array(512), new Float32Array(512)]),
            (this.positions = new Float32Array(1536)),
            ...
            },
            {
              ...
              value: function () {
                ...
                (this.gl.shaderSource(
                  ...
                  this.gl.attachShader(this.shaderProgram, e),
                  this.gl.linkProgram(this.shaderProgram),
                  (this.aPosLocation = this.gl.getAttribLocation(
                    this.shaderProgram,
                    'aPos',
                  )),
                  ...
                  (this.sizeLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'uSize',
                  )),
                  (this.thickOffsetLoc = this.gl.getUniformLocation(
              ...
              value: function (t, e, i, s, r, a, h, o) {
                if (0 !== h.baseVals.enabled && t.length > 0) {
                  var n = Object.assign(
                      ...
                      a.mdVSQAfterFrame,
                      a.mdVSTWaveInits[this.index],
                      r,
                    ),
                    l = h.frame_eqs(n);
                  (Object.prototype.hasOwnProperty.call(l, 'samples')
                    ? (this.samples = l.samples)
                    : (this.samples = 512),
                    this.samples > 512 && (this.samples = 512),
                    (this.samples = Math.floor(this.samples)));
                  var m = Math.floor(l.sep),
                    u = l.scaling,
                    g = l.spectrum,
                    A = l.smoothing,
                    f = l.usedots,
                  ...
                  if (
                    ((this.samples -= m),
                    this.samples >= 2 || (0 !== f && this.samples >= 1))
                  ) {
                    var T = 0 !== g,
                      E = (T ? 0.15 : 0.004) * u * x,
                      P = T ? i : t,
                      R = T ? s : e,
                      L = T ? 0 : Math.floor((512 - this.samples) / 2 - m / 2),
                      S = T ? 0 : Math.floor((512 - this.samples) / 2 + m / 2),
                      y = T ? (512 - m) / this.samples : 1,
                      w = Math.pow(0.98 * A, 0.5),
                      U = 1 - w;
                    ((this.pointsData[0][0] = P[L]),
                      (this.pointsData[1][0] = R[S]));
                    for (var M = 1; M < this.samples; M++) {
                      var F = P[Math.floor(M * y + L)],
                        q = R[Math.floor(M * y + S)];
                      ((this.pointsData[0][M] =
                        F * U + this.pointsData[0][M - 1] * w),
                        (this.pointsData[1][M] =
                          q * U + this.pointsData[1][M - 1] * w));
                    }
                    for (var z = this.samples - 2; z >= 0; z--)
                      ((this.pointsData[0][z] =
                        this.pointsData[0][z] * U +
                        this.pointsData[0][z + 1] * w),
                        (this.pointsData[1][z] =
                          this.pointsData[1][z] * U +
                          this.pointsData[1][z + 1] * w));
                    for (var B = 0; B < this.samples; B++)
                      ((this.pointsData[0][B] *= E),
                        (this.pointsData[1][B] *= E));
                    for (var C = 0; C < this.samples; C++) {
                      var D = this.pointsData[0][C],
                        V = this.pointsData[1][C];
                      ((l.sample = C / (this.samples - 1)),
                        (l.value1 = D),
                        (l.value2 = V),
                        (l.x = 0.5 + D),
                        (l.y = 0.5 + V),
                        ...
                        (l.b = p),
                        (l.a = _),
                        '' !== h.point_eqs && (l = h.point_eqs(l)));
                      var I = (2 * l.x - 1) * this.invAspectx,
                        X = (-2 * l.y + 1) * this.invAspecty,
                        k = l.r,
                        N = l.g,
                        O = l.b,
                        W = l.a;
                      ((this.positions[3 * C + 0] = I),
                        (this.positions[3 * C + 1] = X),
                        (this.positions[3 * C + 2] = 0),
                        (this.colors[4 * C + 0] = k),
                        (this.colors[4 * C + 1] = N),
                        (this.colors[4 * C + 2] = O),
                        (this.colors[4 * C + 3] = W * o));
                    }
                    var Q = a.mdVSUserKeysWaves[this.index],
                      Y = c.pick(l, Q);
                    return (
                      (a.mdVSFrameMapWaves[this.index] = Y),
                      (this.mdVSWaveFrame = l),
                      0 === f &&
                        b.smoothWaveAndColor(
                          this.positions,
                          this.colors,
                          this.smoothedPositions,
                          this.smoothedColors,
              ...
              value: function (t, e, i, s, r, a, h, o) {
                if (o && this.generateWaveform(e, i, s, r, a, h, o, t)) {
                  ...
                  var n,
                    l,
                    m,
                    u = 0 !== this.mdVSWaveFrame.usedots,
                    g = 0 !== this.mdVSWaveFrame.thick,
                    c = 0 !== this.mdVSWaveFrame.additive;
                  (u
                    ? ((n = this.positions),
                      (l = this.colors),
                      (m = this.samples))
                    : ((n = this.smoothedPositions),
                      (l = this.smoothedColors),
                      (m = 2 * this.samples - 1)),
                    this.gl.bindBuffer(
                      this.gl.ARRAY_BUFFER,
                      this.positionVertexBuf,
                    ),
                    this.gl.bufferData(
                      this.gl.ARRAY_BUFFER,
                      n,
                  ...
                  (u
                    ? g
                      ? this.gl.uniform1f(
                          this.sizeLoc,
                          2 + (this.texsizeX >= 1024 ? 1 : 0),
                        )
                      : this.gl.uniform1f(
                          this.sizeLoc,
                          1 + (this.texsizeX >= 1024 ? 1 : 0),
                        )
                    : (this.gl.uniform1f(this.sizeLoc, 1), g && (A = 4)),
                    c
                      ? this.gl.blendFunc(this.gl.SRC_ALPHA, this.gl.ONE)
                      : this.gl.blendFunc(
                          this.gl.SRC_ALPHA,
                  ...
                  for (
                    var f = u ? this.gl.POINTS : this.gl.LINE_STRIP, d = 0;
                    d < A;
                    d++
                  ) {
                    (0 === d
      ...
      var S = (function () {
        function t(e, i, s) {
          ...
          ((this.positions = new Float32Array(309)),
            ...
            i.samplerParameteri(this.mainSampler, i.TEXTURE_WRAP_S, i.REPEAT),
            i.samplerParameteri(this.mainSampler, i.TEXTURE_WRAP_T, i.REPEAT));
        }
        var e, i, s;
        return (
          (e = t),
          (i = [
            ...
            },
            {
              ...
              value: function () {
                ...
                (this.gl.shaderSource(
                  ...
                  (this.aUvLocation = this.gl.getAttribLocation(
                    this.shaderProgram,
                    'aUv',
                  )),
            ...
            },
            {
              key: 'drawCustomShape',
              value: function (t, e, i, s, r) {
                if (0 !== s.baseVals.enabled) {
                  this.setupShapeBuffers(i.mdVSFrame);
                  for (
                    var a = Object.assign(
                        {},
                        i.mdVSShapes[this.index],
                        i.mdVSFrameMapShapes[this.index],
                        i.mdVSQAfterFrame,
                        i.mdVSTShapeInits[this.index],
                        e,
                      ),
                      h = c.cloneVars(a),
                      o = Math.clamp(a.num_inst, 1, 1024),
                      n = 0;
                    n < o;
                    n++
                  ) {
                    ((a.instance = n),
                      ...
                      (a.b2 = h.b2),
                      (a.a2 = h.a2),
                      (a.border_r = h.border_r),
                      (a.border_g = h.border_g),
                      (a.border_b = h.border_b),
                      (a.border_a = h.border_a),
                      (a.thickoutline = h.thickoutline),
                      (a.textured = h.textured),
                      (a.tex_zoom = h.tex_zoom),
                      (a.tex_ang = h.tex_ang),
                      (a.additive = h.additive));
                    var l = s.frame_eqs(a),
                      m = l.sides;
                    ...
                    ((this.positions[0] = A),
                      ...
                      (this.colors[2] = p),
                      (this.colors[3] = _ * t),
                      z && ((this.uvs[0] = 0.5), (this.uvs[1] = 0.5)));
                    for (var D = 0.25 * Math.PI, V = 1; V <= m + 1; V++) {
                      var I = 2 * ((V - 1) / m) * Math.PI,
                        X = I + g + D;
                      if (
                        ((this.positions[3 * V + 0] =
                          A + u * Math.cos(X) * this.aspecty),
                        (this.positions[3 * V + 1] = f + u * Math.sin(X)),
                        (this.positions[3 * V + 2] = 0),
                        (this.colors[4 * V + 0] = x),
                        (this.colors[4 * V + 1] = b),
                        (this.colors[4 * V + 2] = T),
                        (this.colors[4 * V + 3] = E * t),
                        z)
                      ) {
                        var k = I + M + D;
                        ((this.uvs[2 * V + 0] =
                          0.5 + ((0.5 * Math.cos(k)) / U) * this.aspecty),
                          (this.uvs[2 * V + 1] =
                            0.5 + (0.5 * Math.sin(k)) / U));
                      }
                      q &&
                        ((this.borderPositions[3 * (V - 1) + 0] =
                          this.positions[3 * V + 0]),
                        (this.borderPositions[3 * (V - 1) + 1] =
                          this.positions[3 * V + 1]),
                        (this.borderPositions[3 * (V - 1) + 2] =
                          this.positions[3 * V + 2]));
                    }
                    ((this.mdVSShapeFrame = l),
                      this.drawCustomShapeInstance(r, m, z, q, B, C));
                  }
                  var N = i.mdVSUserKeysShapes[this.index],
                    O = c.pick(this.mdVSShapeFrame, N);
            ...
            },
            {
              ...
              value: function (t, e, i, s, r, a) {
                ...
                (this.gl.bindBuffer(
                  ...
                  this.gl.bufferSubData(this.gl.ARRAY_BUFFER, 0, h),
                  this.gl.vertexAttribPointer(
                    this.aPosLocation,
                    3,
                    this.gl.FLOAT,
                ...
                if (
                  ...
                  this.gl.bufferSubData(this.gl.ARRAY_BUFFER, 0, o),
                  this.gl.vertexAttribPointer(
                    this.aColorLocation,
                    4,
                    this.gl.FLOAT,
                  ...
                  (this.gl.bindBuffer(this.gl.ARRAY_BUFFER, this.uvVertexBuf),
                    this.gl.bufferSubData(this.gl.ARRAY_BUFFER, 0, n),
                    this.gl.vertexAttribPointer(
                      this.aUvLocation,
                      2,
                      this.gl.FLOAT,
                ...
                if (
                  (this.gl.uniform1f(this.texturedLoc, i ? 1 : 0),
                  ...
                  (this.gl.bindBuffer(
                    ...
                    this.gl.bufferSubData(this.gl.ARRAY_BUFFER, 0, l),
                    this.gl.vertexAttribPointer(
                      this.aBorderPosLoc,
                      3,
                      this.gl.FLOAT,
            ...
            },
            {
              ...
              value: function (t, e, i, s) {
                ((this.positions[t + 0] = e[0]),
                  ...
                  (this.positions[t + 3] = i[0]),
                  (this.positions[t + 4] = i[1]),
                  (this.positions[t + 5] = i[2]),
                  (this.positions[t + 6] = s[0]),
                  (this.positions[t + 7] = s[1]),
                  (this.positions[t + 8] = s[2]));
              },
            },
            {
              key: 'generateBorder',
              value: function (t, e, i) {
                if (e > 0 && t[3] > 0) {
                  var s = i / 2,
                    ...
                    g = [-1 + o, -1 + n, 0];
                  return (
                    this.addTriangle(0, g, m, l),
                    this.addTriangle(9, g, u, m),
                    (l = [1 - a, -1 + n, 0]),
                    (m = [1 - a, 1 - n, 0]),
                    (u = [1 - o, 1 - n, 0]),
                    (g = [1 - o, -1 + n, 0]),
                    this.addTriangle(18, l, m, g),
                    this.addTriangle(27, m, u, g),
                    (l = [-1 + a, -1 + h, 0]),
                    (m = [-1 + a, n - 1, 0]),
                    (u = [1 - a, n - 1, 0]),
                    (g = [1 - a, -1 + h, 0]),
                    this.addTriangle(36, g, m, l),
                    this.addTriangle(45, g, u, m),
                    (l = [-1 + a, 1 - h, 0]),
                    (m = [-1 + a, 1 - n, 0]),
                    (u = [1 - a, 1 - n, 0]),
                    (g = [1 - a, 1 - h, 0]),
                    this.addTriangle(54, l, m, g),
                    this.addTriangle(63, m, u, g),
                    !0
                  );
                }
                return !1;
          ...
          (i = [
            ...
            },
            {
              ...
              value: function (t, e, i) {
                var s,
                  r,
                  a = Math.floor(i * this.mesh_height),
                  ...
                  u = this.mesh_width + 1;
                return (
                  (s = t[2 * (a * u + o) + 0] * (1 - n) * (1 - h)),
                  (r = t[2 * (a * u + o) + 1] * (1 - n) * (1 - h)),
                  (s += t[2 * (a * u + l) + 0] * n * (1 - h)),
                  (r += t[2 * (a * u + l) + 1] * n * (1 - h)),
                  (s += t[2 * (m * u + o) + 0] * (1 - n) * h),
                  (r += t[2 * (m * u + o) + 1] * (1 - n) * h),
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                if (i > 0.001 && s > 0 && r > 0) {
                  var a = t.mv_x - s,
                    h = t.mv_y - r;
                  (s > this.maxX && ((s = this.maxX), (a = 0)),
                    r > this.maxY && ((r = this.maxY), (h = 0)));
                  var o = t.mv_dx,
                    n = t.mv_dy,
                    l = t.mv_l,
                    m = 1 / this.texsizeX;
                  this.numVecVerts = 0;
                  for (var u = 0; u < r; u++) {
                    var g = (u + 0.25) / (r + h + 0.25 - 1);
                    if ((g -= n) > 1e-4 && g < 0.9999)
                      for (var c = 0; c < s; c++) {
                        var A = (c + 0.25) / (s + a + 0.25 - 1);
                        if ((A += o) > 1e-4 && A < 0.9999) {
                          var f = this.getMotionDir(e, A, g),
                            d = f[0],
                            v = f[1],
                            p = d - A,
                            _ = v - g;
                          ...
                          var b = 2 * A - 1,
                            ...
                            E = 2 * (d = A + p) - 1,
                            P = 2 * (v = g + _) - 1;
                          ((this.positions[3 * this.numVecVerts + 0] = b),
                            (this.positions[3 * this.numVecVerts + 1] = T),
                            (this.positions[3 * this.numVecVerts + 2] = 0),
                            (this.positions[3 * (this.numVecVerts + 1) + 0] =
                              E),
                            (this.positions[3 * (this.numVecVerts + 1) + 1] =
                              P),
                            (this.positions[3 * (this.numVecVerts + 1) + 2] =
                              0),
                            (this.numVecVerts += 2));
                        }
                      }
                  ...
                  if (this.numVecVerts > 0)
                    return ((this.color = [t.mv_r, t.mv_g, t.mv_b, i]), !0);
                }
                return !1;
              },
            },
      ...
      var B = (function () {
        function t(e, i, s) {
          ...
          (!(function (t, e) {
            ...
            (this.noise = i),
            (this.image = s),
            (this.texsizeX = r.texsizeX),
            (this.texsizeY = r.texsizeY),
            (this.mesh_width = r.mesh_width),
            (this.mesh_height = r.mesh_height),
            (this.aspectx = r.aspectx),
            (this.aspecty = r.aspecty),
            (this.invAspectx = 1 / this.aspectx),
            (this.invAspecty = 1 / this.aspecty),
            this.buildPositions(),
            (this.indexBuf = e.createBuffer()),
            (this.positionVertexBuf = this.gl.createBuffer()),
            ...
            e.samplerParameteri(this.mainSamplerFW, e.TEXTURE_WRAP_S, e.REPEAT),
            e.samplerParameteri(this.mainSamplerFW, e.TEXTURE_WRAP_T, e.REPEAT),
            e.samplerParameteri(
              this.mainSamplerFC,
              e.TEXTURE_MIN_FILTER,
              e.LINEAR_MIPMAP_LINEAR,
            ...
            e.samplerParameteri(this.mainSamplerPW, e.TEXTURE_WRAP_S, e.REPEAT),
            e.samplerParameteri(this.mainSamplerPW, e.TEXTURE_WRAP_T, e.REPEAT),
            e.samplerParameteri(
              this.mainSamplerPC,
              e.TEXTURE_MIN_FILTER,
              e.NEAREST_MIPMAP_NEAREST,
                ...
                for (var u = [], g = 0; g < e; g++)
                  for (var c = 0; c < t; c++) {
                    var A = c + i * g,
                      ...
                      d = c + 1 + i * (g + 1),
                      v = c + 1 + i * g;
                    (u.push(A, f, v), u.push(f, d, v));
                  }
                ((this.vertices = new Float32Array(h)),
                  (this.indices = new Uint16Array(u)));
              },
            },
            {
              key: 'updateGlobals',
            ...
            },
            {
              ...
              value: function () {
                var t,
                  ...
                  i =
                    arguments.length > 0 && void 0 !== arguments[0]
                      ...
                      : '';
                if (0 === i.length)
                  ((t = 'ret = texture(sampler_main, uv).rgb * decay;'),
                    (e = ''));
                else {
                  var s = _.getShaderParts(i);
                  ((e = s[0]), (t = s[1]));
                }
                ((t = (t = t.replace(/texture2D/g, 'texture')).replace(
                  /texture3D/g,
                  'texture',
                )),
                  (this.userTextures = _.getUserSamplers(e)),
                  (this.shaderProgram = this.gl.createProgram()));
                ...
                (this.gl.shaderSource(
                  ...
                  _mwCheckShader(this.gl, r, 'warp vertex'),
                  _mwCheckShader(this.gl, a, 'warp fragment'),
                  this.gl.attachShader(this.shaderProgram, r),
                  this.gl.attachShader(this.shaderProgram, a),
                  this.gl.linkProgram(this.shaderProgram),
                  _mwCheckProgram(this.gl, this.shaderProgram, 'warp'),
                  ...
                  (this.decayLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'decay',
                  )),
                  (this.texsizeLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'texsize',
                  )),
                  ...
                  (this.aspectLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'aspect',
                  )),
                  (this.bassLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'bass',
                  )),
                  (this.midLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'mid',
                  )),
                  (this.trebLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'treb',
                  )),
                  (this.volLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'vol',
                  )),
                  ...
                  (this.midAttLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'mid_att',
                  )),
                  ...
                  (this.volAttLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'vol_att',
                  )),
                  (this.timeLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'time',
                  )),
                  (this.frameLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'frame',
                  )),
                  (this.fpsLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'fps',
                  )),
                  ...
                  (this.scale1Loc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'scale1',
                  )),
                  (this.scale2Loc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'scale2',
                  )),
                  (this.scale3Loc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'scale3',
                  )),
                  (this.bias1Loc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'bias1',
                  )),
                  (this.bias2Loc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'bias2',
                  )),
                  (this.bias3Loc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'bias3',
                  )),
                  ...
                  (this.qaLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    '_qa',
                  )),
                  (this.qbLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    '_qb',
                  )),
                  (this.qcLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    '_qc',
                  )),
                  (this.qdLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    '_qd',
                  )),
                  (this.qeLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    '_qe',
                  )),
                  (this.qfLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    '_qf',
                  )),
                  (this.qgLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    '_qg',
                  )),
                  (this.qhLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    '_qh',
                  )),
                  ...
                  (this.mwFpsRatioLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    '_mw_fps_ratio',
                  ))); /* [MW-PATCH: _mw_fps_ratio uniform location] */
                for (var h = 0; h < this.userTextures.length; h++) {
                  var o = this.userTextures[h];
                  o.textureLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'sampler_'.concat(o.sampler),
                  );
                }
              },
            },
            ...
            },
            {
              ...
              value: function (t, e) {
                var i = t[0],
                  ...
                  g = o - r,
                  c = r;
                (this.gl.uniform1f(this.blur1MinLoc, i),
                  this.gl.uniform1f(this.blur1MaxLoc, a),
                  this.gl.uniform1f(this.blur2MinLoc, s),
                  this.gl.uniform1f(this.blur2MaxLoc, h),
                  this.gl.uniform1f(this.blur3MinLoc, r),
                  this.gl.uniform1f(this.blur3MaxLoc, o),
                  this.gl.uniform1f(this.scale1Loc, n),
                  this.gl.uniform1f(this.scale2Loc, m),
                  this.gl.uniform1f(this.scale3Loc, g),
                  this.gl.uniform1f(this.bias1Loc, l),
                  this.gl.uniform1f(this.bias2Loc, u),
                  this.gl.uniform1f(this.bias3Loc, c));
              },
            },
            {
              ...
              value: function (t, e, i, s, r, a, h, o, n, l) {
                ...
                var m = 0 !== o.wrap ? this.gl.REPEAT : this.gl.CLAMP_TO_EDGE;
                (this.gl.samplerParameteri(
                  this.mainSampler,
                  this.gl.TEXTURE_WRAP_S,
                  m,
                  ...
                  this.gl.bindTexture(
                    this.gl.TEXTURE_3D,
                    this.noise.noiseTexVolLQ,
                  ),
                  this.gl.uniform1i(this.noiseVolLQLoc, 13),
                  this.gl.activeTexture(this.gl.TEXTURE14),
                  this.gl.bindTexture(
                    this.gl.TEXTURE_3D,
                    this.noise.noiseTexVolHQ,
                  ),
                  this.gl.uniform1i(this.noiseVolHQLoc, 14));
                for (var u = 0; u < this.userTextures.length; u++) {
                  var g = this.userTextures[u];
                  (this.gl.activeTexture(this.gl.TEXTURE15 + u),
                    this.gl.bindTexture(
                      this.gl.TEXTURE_2D,
                      this.image.getTexture(g.sampler),
                    ),
                    this.gl.uniform1i(g.textureLoc, 15 + u));
                }
                (this.gl.uniform1f(this.decayLoc, o.decay),
                  ...
                  this.gl.uniform1f(
                    this.volAttLoc,
                    (o.bass_att + o.mid_att + o.treb_att) / 3,
                  ),
                  this.gl.uniform1f(this.timeLoc, o.time),
                  this.gl.uniform1f(this.frameLoc, o.frame),
                  this.gl.uniform1f(this.fpsLoc, o.fps),
                  this.gl.uniform1f(this.mwFpsRatioLoc, 30.0 / o.fps), /* [MW-PATCH: _mw_fps_ratio uniform] */
              ...
              value: function (t) {
                for (
                  ...
                  ((e[3 * i + 0] =
                    ...
                    0.3 *
                      Math.sin(
                        30 * t.time * 0.0143 + 3 + 21 * i + t.rand_start[3],
                      )),
                    (e[3 * i + 1] =
                      0.6 +
                      0.3 *
                        Math.sin(
                          30 * t.time * 0.0107 + 1 + 13 * i + t.rand_start[1],
                        )),
                    (e[3 * i + 2] =
                      0.6 +
                      0.3 *
                        Math.sin(
                          30 * t.time * 0.0129 + 6 + 9 * i + t.rand_start[2],
                        )));
                  for (
                    var s = Math.max(e[3 * i], e[3 * i + 1], e[3 * i + 2]),
                      r = 0;
                    r < 3;
                    r++
                  )
                    ((e[3 * i + r] = e[3 * i + r] / s),
                      (e[3 * i + r] = 0.5 + 0.5 * e[3 * i + r]));
                }
                return e;
              },
            },
          ...
          (i = [
            ...
            },
            {
              ...
              value: function () {
                ...
                (this.gl.shaderSource(
                  ...
                  this.gl.compileShader(a),
                  _mwCheckShader(this.gl, r, 'comp vertex'),
                  _mwCheckShader(this.gl, a, 'comp fragment'),
                  this.gl.attachShader(this.shaderProgram, r),
                  this.gl.attachShader(this.shaderProgram, a),
                  this.gl.linkProgram(this.shaderProgram),
                  _mwCheckProgram(this.gl, this.shaderProgram, 'comp'),
                  (this.positionLocation = this.gl.getAttribLocation(
                    this.shaderProgram,
                    'aPos',
                  )),
                  ...
                  (this.invertLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'invert',
                  )),
                  ...
                  (this.darkenLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'darken',
                  )),
                  ...
                  (this.fShaderLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'fShader',
                  )),
                  (this.qaLoc = this.gl.getUniformLocation(
            ...
            },
            {
              ...
              value: function (e, i, s) {
                for (
                  var r = t.generateHueBase(i),
                    a = this.compWidth + 1,
                    h = this.compHeight + 1,
                    o = new Float32Array(a * h * 4),
                    n = 0,
                    l = 0;
                  l < h;
                  l++
                  ...
                  for (var m = 0; m < a; m++) {
                    ...
                    if (e) {
                      ((u *= this.mesh_width + 1),
                        (g *= this.mesh_height + 1),
                        (u = Math.clamp(u, 0, this.mesh_width - 1)),
                        (g = Math.clamp(g, 0, this.mesh_height - 1)));
                      var d = Math.floor(u),
                        v = Math.floor(g),
                        p = u - d,
                        _ = g - v;
                      f =
                        s[4 * (v * (this.mesh_width + 1) + d) + 3] *
                          (1 - p) *
                          (1 - _) +
                        s[4 * (v * (this.mesh_width + 1) + (d + 1)) + 3] *
                          p *
                          (1 - _) +
                        s[4 * ((v + 1) * (this.mesh_width + 1) + d) + 3] *
                          (1 - p) *
                          _ +
                        s[4 * ((v + 1) * (this.mesh_width + 1) + (d + 1)) + 3] *
                          p *
                          _;
                    }
                    ((o[n + 0] = c[0]),
      ...
      var I = (function () {
        function t(e, i) {
          (!(function (t, e) {
            ...
            (this.gl = e),
            (this.textureRatio = i.textureRatio),
            (this.texsizeX = i.texsizeX),
            (this.texsizeY = i.texsizeY),
      ...
      var O = (function () {
        function t(e, i) {
          (!(function (t, e) {
            ...
            (this.gl = e),
            (this.blurLevel = i));
          var s = [4, 3.8, 3.5, 2.9, 1.9, 1.2, 0.7, 0.3],
            r = s[0] + s[1] + s[2] + s[3],
            a = s[4] + s[5] + s[6] + s[7],
            h = 0 + ((s[2] + s[3]) / r) * 2,
            o = 2 + ((s[6] + s[7]) / a) * 2;
          ((this.wds = new Float32Array([r, a, h, o])),
            (this.wDiv = 1 / (2 * (r + a))),
            (this.positions = new Float32Array([-1, -1, 1, -1, -1, 1, 1, 1])),
            (this.vertexBuf = this.gl.createBuffer()),
            (this.floatPrecision = _.getFragmentFloatPrecision(this.gl)),
          ...
          (i = [
            {
              ...
              value: function () {
                ...
                (this.gl.shaderSource(
                  ...
                  (this.ed1Loc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'ed1',
                  )),
                  (this.ed2Loc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'ed2',
                  )),
                  (this.ed3Loc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'ed3',
                  )),
                  (this.wdsLocation = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'wds',
                  )),
                  (this.wdivLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'wdiv',
                  )));
              },
            },
            {
              ...
              value: function (t, e, i) {
                ...
                (this.gl.uniform4fv(this.texsizeLocation, [
                  ...
                  this.gl.uniform1f(this.ed1Loc, 1 - s),
                  this.gl.uniform1f(this.ed2Loc, s),
      ...
      var Q = (function () {
        function t(e, i) {
          ...
          var s = [4, 3.8, 3.5, 2.9, 1.9, 1.2, 0.7, 0.3],
            ...
            m = 4 + (2 * s[5]) / h,
            u = 6 + (2 * s[7]) / o;
          ((this.ws = new Float32Array([r, a, h, o])),
            (this.ds = new Float32Array([n, l, m, u])),
            (this.wDiv = 0.5 / (r + a + h + o)),
            (this.positions = new Float32Array([-1, -1, 1, -1, -1, 1, 1, 1])),
            (this.vertexBuf = this.gl.createBuffer()),
            (this.floatPrecision = _.getFragmentFloatPrecision(this.gl)),
            this.createShader());
          ...
          (i = [
            {
              ...
              value: function () {
                ...
                (this.gl.shaderSource(
                  ...
                  (this.scaleLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'scale',
                  )),
                  (this.biasLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'bias',
                  )),
                  (this.wsLoc = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'ws',
                  )),
                  (this.dsLocation = this.gl.getUniformLocation(
                    this.shaderProgram,
                    'ds',
                  )),
                  (this.wdivLoc = this.gl.getUniformLocation(
            ...
            },
            {
              ...
              value: function (t, e, i, s, r) {
                ...
                (this.gl.uniform4fv(this.texsizeLocation, [
                  ...
                  this.gl.uniform1f(this.scaleLoc, h),
                  this.gl.uniform1f(this.biasLoc, o),
      ...
      var G = (function () {
        function t(e, i, s) {
          ...
          (!(function (t, e) {
            ...
            (this.blurHorizontal = new Q(s, this.blurLevel, r)),
            (this.blurVertical = new O(s, this.blurLevel, r)));
        }
        var e, i, s;
        return (
          (e = t),
          (i = [
            ...
            },
            {
              ...
              value: function () {
                var t =
                    this.blurLevel > 0
                      ? this.blurRatios[this.blurLevel - 1]
                      : [1, 1],
      ...
      var j = (function () {
        function t(e) {
          (!(function (t, e) {
            ...
            (this.nTexArrLQ = t.createNoiseTex(256, 1)),
            (this.nTexArrLQLite = t.createNoiseTex(32, 1)),
            (this.nTexArrMQ = t.createNoiseTex(256, 4)),
            (this.nTexArrHQ = t.createNoiseTex(256, 8)),
            (this.nTexArrVolLQ = t.createNoiseVolTex(32, 1)),
            (this.nTexArrVolHQ = t.createNoiseVolTex(32, 4)),
            ...
            },
            {
              ...
              value: function (e, i) {
                for (
                  ...
                  ((r[4 * o + 0] = Math.floor(Math.random() * a + h)),
                    (r[4 * o + 1] = Math.floor(Math.random() * a + h)),
                    (r[4 * o + 2] = Math.floor(Math.random() * a + h)),
                    (r[4 * o + 3] = Math.floor(Math.random() * a + h)));
                var n = e * e,
                  l = e;
                if (i > 1) {
                  for (var m = 0; m < e; m += i)
                        ...
                        if (g % i != 0) {
                          for (
                            ...
                            ((f[_] = r[4 * A + ((c - i) % e) * 4 + _]),
                              (d[_] = r[4 * A + (c % e) * 4 + _]),
                              (v[_] = r[4 * A + ((c + i) % e) * 4 + _]),
                              (p[_] = r[4 * A + ((c + 2 * i) % e) * 4 + _]));
                          for (
                            var x = (g % i) / i,
                              b = t.dwCubicInterpolate(f, d, v, p, x),
                              T = 0;
                            T < 4;
                            T++
                          ) {
                            r[m * n * 4 + u * l * 4 + (4 * g + T)] = b[T];
                          }
                        }
                  for (var E = 0; E < e; E += i)
                    for (var P = 0; P < e; P++)
                      for (var R = 0; R < e; R++)
                        if (R % i != 0) {
                          ...
                          for (
                            var z = (R % i) / i,
                              B = t.dwCubicInterpolate(y, w, U, M, z),
                              C = 0;
                            C < 4;
                            C++
                          ) {
                            r[R * l * 4 + (4 * P + 4 * S + C)] = B[C];
                          }
                        }
                  for (var D = 0; D < e; D++)
                    for (var V = 0; V < e; V++)
                      for (var I = 0; I < e; I++)
                        if (I % i != 0) {
                          ...
                          for (
                            var H = (V % i) / i,
                              j = t.dwCubicInterpolate(N, O, W, Q, H),
                              K = 0;
                            K < 4;
                            K++
                          ) {
                            r[I * n * 4 + (4 * D + 4 * X + K)] = j[K];
                          }
                        }
                }
                return r;
                      ...
                      if (l % i != 0) {
                        for (
                          ...
                          ((g[d] = r[4 * u + ((m - i) % e) * 4 + d]),
                            (c[d] = r[4 * u + (m % e) * 4 + d]),
                            (A[d] = r[4 * u + ((m + i) % e) * 4 + d]),
                            (f[d] = r[4 * u + ((m + 2 * i) % e) * 4 + d]));
                        for (
                          var v = (l % i) / i,
                            p = t.dwCubicInterpolate(g, c, A, f, v),
                            _ = 0;
                          _ < 4;
                          _++
                        )
                    ...
                    for (var b = 0; b < e; b++)
                      if (b % i != 0) {
                        for (
                          ...
                          ((E[S] = r[((T - i) % e) * e * 4 + 4 * x + S]),
                            (P[S] = r[(T % e) * e * 4 + 4 * x + S]),
                            (R[S] = r[((T + i) % e) * e * 4 + 4 * x + S]),
                            (L[S] = r[((T + 2 * i) % e) * e * 4 + 4 * x + S]));
                        for (
                          var y = (b % i) / i,
                            w = t.dwCubicInterpolate(E, P, R, L, y),
                            U = 0;
                          U < 4;
                          U++
                        )
        ...
        function t(e) {
          ...
          (!(function (t, e) {
            ...
            (this.clouds2Image.onload = function () {
              ((i.samplers.clouds2 = i.gl.createTexture()),
                i.bindTexture(i.samplers.clouds2, i.clouds2Image, 128, 128));
            }),
            ...
            (this.emptyImage.onload = function () {
              ((i.samplers.empty = i.gl.createTexture()),
                i.bindTexture(i.samplers.empty, i.emptyImage, 1, 1));
            }),
            (this.emptyImage.src =
              ...
              value: function (t) {
                ...
                Object.keys(t).forEach(function (i) {
                  ...
                  if (!e.samplers[i]) {
                    var o = new Image();
                    ((o.onload = function () {
                      ((e.samplers[i] = e.gl.createTexture()),
                        e.bindTexture(e.samplers[i], o, a, h));
                    }),
                      (o.src = r));
                  }
                });
          ...
          (i = [
            {
              ...
              value: function (t) {
                (this.context2D.clearRect(0, 0, this.texsizeX, this.texsizeY),
                  ...
                  (this.context2D.font = 'italic '.concat(
                    this.fontSize,
                    'px Times New Roman',
                  )));
                var e = t,
                ...
                if (i > this.texsizeX) {
                  var s = (this.texsizeX / i) * 0.91;
                  ((e = ''.concat(
                    e.substring(0, Math.floor(e.length * s)),
                    '...',
                  )),
                    (i = this.context2D.measureText(e).width));
                }
            ...
            },
            {
              ...
              value: function () {
                ...
                (this.gl.shaderSource(
                  ...
                  (this.uvLocation = this.gl.getAttribLocation(
                    this.shaderProgram,
                    'aUv',
                  )),
                  (this.textureLoc = this.gl.getUniformLocation(
            ...
            },
            {
              ...
              value: function (t, e, i) {
                for (var s = [], r = 0; r < 8; r++)
                  for (var a = 0; a < 16; a++) {
                    var h = 2 * (a / 15) - 1,
                      o = 2 * (0.75 * (r / 7 - 0.5) + 0.5) - 1;
                    (t >= 1 && (o += 1 / this.texsizeY), s.push(h, e ? o : -o));
                  }
                for (
                  var n = Math.max(0, 1 - 1.5 * t),
                    l = 1.3 * Math.pow(n, 1.8),
                    m = 0;
                  m < 8;
                  m++
                )
                  for (var u = 0; u < 16; u++) {
                    ...
                    ((s[g] +=
                      0.07 *
                      l *
                      Math.sin(0.31 * i.time + 0.39 * s[g] - 1.94 * s[g + 1])),
                      (s[g] +=
                        0.044 *
                        l *
                        Math.sin(
                          0.81 * i.time - 1.91 * s[g] + 0.27 * s[g + 1],
                        )),
                      (s[g] +=
                        0.061 *
                        l *
                        Math.sin(
                          1.31 * i.time + 0.61 * s[g] + 0.74 * s[g + 1],
                        )),
                      (s[g + 1] +=
                        0.061 *
                        l *
                        Math.sin(
                          0.37 * i.time + 1.83 * s[g] + 0.69 * s[g + 1],
                        )),
                      (s[g + 1] +=
                        0.07 *
                        l *
                        Math.sin(
                          0.67 * i.time + 0.42 * s[g] - 1.39 * s[g + 1],
                        )),
                      (s[g + 1] +=
                        0.087 *
                        l *
                        Math.sin(
                          1.07 * i.time + 3.55 * s[g] + 0.89 * s[g + 1],
                        )));
                  }
                for (
                  var c = 1.01 / (Math.pow(t, 0.21) + 0.01), A = 0;
                  A < s.length / 2;
                  A++
                )
                  ((s[2 * A] *= c),
                    (s[2 * A + 1] *= c * this.invAspecty),
                    (s[2 * A] = (s[2 * A] + 1) / 2),
                    (s[2 * A + 1] = (s[2 * A + 1] + 1) / 2));
            ...
            },
            {
              ...
              value: function (t, e, i) {
                ...
                (this.gl.bindBuffer(
                  ...
                  this.gl.bindTexture(this.gl.TEXTURE_2D, this.textTexture),
                  this.gl.uniform1i(this.textureLoc, 0),
                  this.gl.uniform1f(this.textColorLoc, Math.pow(t, 0.3)),
                  this.gl.blendFunc(
                    this.gl.SRC_ALPHA,
                    this.gl.ONE_MINUS_SRC_ALPHA,
                  ),
          ...
          (s = [
            {
              ...
              value: function (t, e, i, s, r) {
                for (
                  var a = new Float32Array((s + 1) * (r + 1)), h = 0, o = 0;
                  o < r + 1;
                  o++
                )
                  for (var n = 0; n < s + 1; n++) {
                    ...
                    ((l *= e + 1),
                      (m *= i + 1),
                      (l = Math.clamp(l, 0, e - 1)),
                      (m = Math.clamp(m, 0, i - 1)));
                    var u = Math.floor(l),
                      g = Math.floor(m),
                      c = l - u,
                      A = m - g,
          ...
          (i = [
            {
              ...
              value: function (e) {
                ...
                ((this.mesh_width = e.mesh_width),
                  ...
                  (this.aspectx = e.aspectx),
                  (this.aspecty = e.aspecty),
                  (this.mesh_width === i && this.mesh_height === s) ||
                    ((this.vertInfoA = t.resizeMatrixValues(
                      this.vertInfoA,
                      i,
                      s,
                      this.mesh_width,
                    ...
                    (this.vertInfoC = t.resizeMatrixValues(
                      this.vertInfoC,
                      i,
                      s,
                      this.mesh_width,
            ...
            },
            {
              ...
              value: function (t, e, i, s, r) {
                var a = Math.floor((t + e) / 2),
                  ...
                  m = this.vertInfoC[s * (this.mesh_width + 1) + e];
                (s - i >= 2 &&
                  (0 === t &&
                    (this.vertInfoC[h * (this.mesh_width + 1) + t] =
                      0.5 * (o + l) +
                      (2 * Math.random() - 1) * r * this.aspecty),
                  (this.vertInfoC[h * (this.mesh_width + 1) + e] =
                    0.5 * (n + m) +
                    (2 * Math.random() - 1) * r * this.aspecty)),
                  e - t >= 2 &&
                    (0 === i &&
                      (this.vertInfoC[i * (this.mesh_width + 1) + a] =
                        0.5 * (o + n) +
                        (2 * Math.random() - 1) * r * this.aspectx),
                    (this.vertInfoC[s * (this.mesh_width + 1) + a] =
                      0.5 * (l + m) +
                      (2 * Math.random() - 1) * r * this.aspectx)),
                  s - i >= 2 &&
                    e - t >= 2 &&
                    ((o = this.vertInfoC[h * (this.mesh_width + 1) + t]),
                    (n = this.vertInfoC[h * (this.mesh_width + 1) + e]),
                    (l = this.vertInfoC[i * (this.mesh_width + 1) + a]),
                    (m = this.vertInfoC[s * (this.mesh_width + 1) + a]),
                    (this.vertInfoC[h * (this.mesh_width + 1) + a] =
                      0.25 * (l + m + o + n) + (2 * Math.random() - 1) * r),
                    this.genPlasma(t, a, i, h, 0.5 * r),
                    this.genPlasma(a, e, i, h, 0.5 * r),
                    this.genPlasma(t, a, h, s, 0.5 * r),
                    this.genPlasma(a, e, h, s, 0.5 * r)));
              },
            },
            {
              ...
              value: function () {
                ...
                if (0 === t)
                  for (var e = 0, i = 0; i <= this.mesh_height; i++)
                    for (var s = 0; s <= this.mesh_width; s++)
                      ((this.vertInfoA[e] = 1),
                        (this.vertInfoC[e] = 0),
                        (e += 1));
                else if (1 === t)
                  for (
                    var r = 6.28 * Math.random(),
                      a = Math.cos(r),
                      h = Math.sin(r),
                      o = 0.1 + 0.2 * Math.random(),
                      n = 1 / o,
                      l = 0,
                      m = 0;
                    m <= this.mesh_height;
                    ...
                    for (
                      var u = (m / this.mesh_height) * this.aspecty, g = 0;
                      g <= this.mesh_width;
                      g++
                    ) {
                      var c =
                        ((g / this.mesh_width) * this.aspectx - 0.5) * a +
                        (u - 0.5) * h +
                        0.5;
                      ((c = (c - 0.5) / Math.sqrt(2) + 0.5),
                        (this.vertInfoA[l] = n * (1 + o)),
                        (this.vertInfoC[l] = n * c - n),
                        (l += 1));
                    }
                else if (2 === t) {
                  var A = 0.12 + 0.13 * Math.random(),
                    f = 1 / A;
                  ((this.vertInfoC[0] = Math.random()),
                    (this.vertInfoC[this.mesh_width] = Math.random()),
                    (this.vertInfoC[this.mesh_height * (this.mesh_width + 1)] =
                      Math.random()),
                    (this.vertInfoC[
                  ...
                  for (
                    ...
                    for (var x = 0; x <= this.mesh_width; x++)
                      (d > this.vertInfoC[p] && (d = this.vertInfoC[p]),
                        v < this.vertInfoC[p] && (v = this.vertInfoC[p]),
                        (p += 1));
                  var b = 1 / (v - d);
                  p = 0;
                  for (var T = 0; T <= this.mesh_height; T++)
                    for (var E = 0; E <= this.mesh_width; E++) {
                      ...
                      ((this.vertInfoA[p] = f * (1 + A)),
                        (this.vertInfoC[p] = f * P - f),
                        (p += 1));
                    }
                } else if (3 === t)
                  for (
                    var R = 0.02 + 0.14 * Math.random() + 0.34 * Math.random(),
                      L = 1 / R,
                    ...
                    for (
                      var U = (w / this.mesh_height - 0.5) * this.aspecty,
                        M = 0;
                      M <= this.mesh_width;
                      M++
                    ) {
                      var F = (M / this.mesh_width - 0.5) * this.aspectx,
                        q = 1.41421 * Math.sqrt(F * F + U * U);
                      (-1 === S && (q = 1 - q),
                        (this.vertInfoA[y] = L * (1 + R)),
                        (this.vertInfoC[y] = L * q - L),
                        (y += 1));
                    }
              },
            },
      ...
      var st = (function () {
        function t(e, i, s) {
          (!(function (t, e) {
            ...
            (this.aspectx =
              this.texsizeY > this.texsizeX
                ? this.texsizeX / this.texsizeY
                : 1),
            (this.aspecty =
              this.texsizeX > this.texsizeY
                ? this.texsizeY / this.texsizeX
            ...
            (this.regs = c.range(0, 100).map(function (t) {
              return t < 10 ? 'reg0'.concat(t) : 'reg'.concat(t);
            })),
            (this.blurRatios = [
              [0.5, 0.25],
            ...
            (this.audioLevels = new n(this.audio)),
          ...
          ((this.noise = new j(e)),
            (this.image = new J(e)),
            (this.warpShader = new B(e, this.noise, this.image, r)),
            (this.compShader = new D(e, this.noise, this.image, r)),
            (this.outputShader = new I(e, r)),
            (this.prevWarpShader = new B(e, this.noise, this.image, r)),
            (this.prevCompShader = new D(e, this.noise, this.image, r)),
            (this.numBlurPasses = 0),
            (this.blurShader1 = new G(0, this.blurRatios, e, r)),
            (this.blurShader2 = new G(1, this.blurRatios, e, r)),
            (this.blurShader3 = new G(2, this.blurRatios, e, r)),
            ...
            (this.basicWaveform = new E(e, r)),
            (this.customWaveforms = c.range(4).map(function (t) {
              return new R(t, e, r);
            })),
            (this.customShapes = c.range(4).map(function (t) {
              return new S(t, e, r);
            })),
            (this.prevCustomWaveforms = c.range(4).map(function (t) {
              return new R(t, e, r);
            })),
            (this.prevCustomShapes = c.range(4).map(function (t) {
              return new S(t, e, r);
            })),
            (this.darkenCenter = new M(e, r)),
            (this.innerBorder = new w(e, r)),
            (this.outerBorder = new w(e, r)),
            (this.motionVectors = new q(e, r)),
            (this.titleText = new $(e, r)),
            (this.blendPattern = new et(r)),
            (this.resampleShader = new k(e)),
            (this.supertext = {
              startTime: -1,
            }),
          ...
          ((this.preset = m.a),
            ...
            (this.presetEquationRunner = new f(this.preset, a, r)),
            (this.prevPresetEquationRunner = new f(this.prevPreset, a, r)),
          ...
          (s = [
            {
              key: 'getHighestBlur',
              value: function (t) {
                return /sampler_blur3/.test(t)
                  ? 3
                  : /sampler_blur2/.test(t)
                    ? 2
                    : /sampler_blur1/.test(t)
                      ? 1
                      : 0;
              },
            },
            {
              ...
              value: function (t, e, i) {
                var s = 0.5 - 0.5 * Math.cos(t * Math.PI),
                  ...
                  a = c.cloneVars(e);
                return (
                  (a.decay = s * e.decay + r * i.decay),
                  (a.wave_a = s * e.wave_a + r * i.wave_a),
                  (a.wave_r = s * e.wave_r + r * i.wave_r),
                  (a.wave_g = s * e.wave_g + r * i.wave_g),
                  (a.wave_b = s * e.wave_b + r * i.wave_b),
                  (a.wave_x = s * e.wave_x + r * i.wave_x),
                  (a.wave_y = s * e.wave_y + r * i.wave_y),
                  (a.wave_mystery = s * e.wave_mystery + r * i.wave_mystery),
                  (a.ob_size = s * e.ob_size + r * i.ob_size),
                  (a.ob_r = s * e.ob_r + r * i.ob_r),
                  (a.ob_g = s * e.ob_g + r * i.ob_g),
                  (a.ob_b = s * e.ob_b + r * i.ob_b),
                  (a.ob_a = s * e.ob_a + r * i.ob_a),
                  (a.ib_size = s * e.ib_size + r * i.ib_size),
                  (a.ib_r = s * e.ib_r + r * i.ib_r),
                  (a.ib_g = s * e.ib_g + r * i.ib_g),
                  (a.ib_b = s * e.ib_b + r * i.ib_b),
                  (a.ib_a = s * e.ib_a + r * i.ib_a),
                  (a.mv_x = s * e.mv_x + r * i.mv_x),
                  (a.mv_y = s * e.mv_y + r * i.mv_y),
                  (a.mv_dx = s * e.mv_dx + r * i.mv_dx),
                  (a.mv_dy = s * e.mv_dy + r * i.mv_dy),
                  (a.mv_l = s * e.mv_l + r * i.mv_l),
                  (a.mv_r = s * e.mv_r + r * i.mv_r),
                  (a.mv_g = s * e.mv_g + r * i.mv_g),
                  (a.mv_b = s * e.mv_b + r * i.mv_b),
                  (a.mv_a = s * e.mv_a + r * i.mv_a),
                  (a.echo_zoom = s * e.echo_zoom + r * i.echo_zoom),
                  (a.echo_alpha = s * e.echo_alpha + r * i.echo_alpha),
                  (a.echo_orient = s * e.echo_orient + r * i.echo_orient),
                  (a.wave_dots = s < 0.5 ? i.wave_dots : e.wave_dots),
                  (a.wave_thick = s < 0.5 ? i.wave_thick : e.wave_thick),
                  (a.additivewave = s < 0.5 ? i.additivewave : e.additivewave),
                  (a.wave_brighten =
                    s < 0.5 ? i.wave_brighten : e.wave_brighten),
                  (a.darken_center =
                    s < 0.5 ? i.darken_center : e.darken_center),
                  (a.gammaadj = s < 0.5 ? i.gammaadj : e.gammaadj),
                  (a.wrap = s < 0.5 ? i.wrap : e.wrap),
                  (a.invert = s < 0.5 ? i.invert : e.invert),
                  (a.brighten = s < 0.5 ? i.brighten : e.brighten),
                  (a.darken = s < 0.5 ? i.darken : e.darken),
                  (a.solarize = s < 0.5 ? i.brighten : e.solarize),
                  (a.b1n = s * e.b1n + r * i.b1n),
                  (a.b2n = s * e.b2n + r * i.b2n),
                  (a.b3n = s * e.b3n + r * i.b3n),
                  (a.b1x = s * e.b1x + r * i.b1x),
                  (a.b2x = s * e.b2x + r * i.b2x),
                  (a.b3x = s * e.b3x + r * i.b3x),
                  (a.b1ed = s * e.b1ed + r * i.b1ed),
                  a
                );
              },
            },
            {
              ...
              value: function (t) {
                ...
                if ((a = Math.min(r, a)) - (i = Math.max(e, i)) < 0.1) {
                  var n = 0.5 * (i + a);
                  ((i = n - 0.05), (a = n - 0.05));
                }
                if ((h = Math.min(a, h)) - (s = Math.max(i, s)) < 0.1) {
                  var l = 0.5 * (s + h);
                  ((s = l - 0.05), (h = l - 0.05));
                }
                return {
          ...
          (i = [
            {
              ...
              value: function (e, i) {
                (this.blendPattern.createBlendPattern(),
                  ...
                  (this.prevPreset = this.preset),
                  (this.preset = e),
                  (this.preset.baseVals.old_wave_mode =
                    this.prevPreset.baseVals.wave_mode),
                ...
                ((this.presetEquationRunner = new f(this.preset, s, r)),
                  (this.regVars = this.presetEquationRunner.mdVSRegs));
                var a = this.prevWarpShader;
                ((this.prevWarpShader = this.warpShader),
                  (this.warpShader = a));
                var h = this.prevCompShader;
                ((this.prevCompShader = this.compShader),
                  (this.compShader = h));
                var o = this.preset.warp.trim(),
                  n = this.preset.comp.trim();
                (this.warpShader.updateShader(o),
                  this.compShader.updateShader(n),
                  0 === o.length
                    ? (this.numBlurPasses = 0)
                    : (this.numBlurPasses = t.getHighestBlur(o)),
                  0 !== n.length &&
            ...
            },
            {
              ...
              value: function (t, e, i) {
                ...
                if (
                  ((this.width = t),
                  (this.height = e),
                  (this.mesh_width = i.meshWidth || this.mesh_width),
                  (this.mesh_height = i.meshHeight || this.mesh_height),
                  (this.pixelRatio = i.pixelRatio || this.pixelRatio),
                  (this.textureRatio = i.textureRatio || this.textureRatio),
                  ...
                  (this.aspecty =
                    this.texsizeX > this.texsizeY
                      ? this.texsizeY / this.texsizeX
                      : 1),
                  this.texsizeX !== s || this.texsizeY !== r)
                ) {
                  var a = this.gl.createTexture();
                  (this.bindFrameBufferTexture(this.targetFrameBuffer, a),
                    this.bindFrambufferAndSetViewport(
                      this.targetFrameBuffer,
                      this.texsizeX,
                      this.texsizeY,
                ...
                (this.updateGlobals(),
                  this.frameNum > 0 && this.renderToScreen());
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                ...
                (this.presetEquationRunner.updateGlobals(t),
                  ...
                  this.customWaveforms.forEach(function (e) {
              ...
              value: function (t) {
                ...
                ((this.time += 1 / this.fps),
                  this.blending &&
                    ...
                    this.blendProgress > 1 && (this.blending = !1)));
                var s = this.timeHist[this.timeHist.length - 1] + e;
                (this.timeHist.push(s),
                  this.timeHist.length > this.timeHistMax &&
                    this.timeHist.shift());
                var r = this.timeHist.length / (s - this.timeHist[0]);
                if (Math.abs(r - this.fps) > 3 && this.frame > this.timeHistMax)
                  this.fps = r;
                else {
                  this.fps = 0.93 * this.fps + (1 - 0.93) * r;
                }
              },
            },
            {
              ...
              value: function (t, e, i, s) {
                for (
                  var r = this.mesh_width,
                    a = this.mesh_height,
                    h = r + 1,
                    o = a + 1,
                    n = this.time * e.warpanimspeed,
                    l = 1 / e.warpscale,
                    m = 11.68 + 4 * Math.cos(1.413 * n + 10),
                    u = 8.77 + 3 * Math.cos(1.113 * n + 7),
                    g = 10.54 + 3 * Math.cos(1.233 * n + 3),
                    A = 11.49 + 4 * Math.cos(0.933 * n + 5),
                    f = 0 / this.texsizeX,
                    d = 0 / this.texsizeY,
                    v = this.aspectx,
                    p = this.aspecty,
                  ...
                  for (var E = 0; E < h; E++) {
                    var P = (E / r) * 2 - 1,
                      R = (T / a) * 2 - 1,
                      L = Math.sqrt(P * P * v * v + R * R * p * p);
                    if (i) {
                      var S = void 0;
                      ((S =
                        T === a / 2 && E === r / 2 ? 0 : c.atan2(R * p, P * v)),
                        (_.x = 0.5 * P * v + 0.5),
                        (_.y = -0.5 * R * p + 0.5),
                        (_.rad = L),
                        (_.ang = S),
                    ...
                    var y = _.warp,
                      ...
                      C = _.dy,
                      D = _.rot,
                      V = 1 / Math.pow(w, Math.pow(U, 2 * L - 1)),
                      I = 0.5 * P * v * V + 0.5,
                      X = 0.5 * -R * p * V + 0.5;
                    ((I = (I - M) / q + M),
                      (X = (X - F) / z + F),
                      0 !== y &&
                        ((I +=
                          0.0035 *
                          y *
                          Math.sin(0.333 * n + l * (P * m - R * A))),
                        (X +=
                          0.0035 *
                          y *
                          Math.cos(0.375 * n - l * (P * g + R * u))),
                        (I +=
                          0.0035 *
                          y *
                          Math.cos(0.753 * n - l * (P * u - R * g))),
                        (X +=
                          0.0035 *
                          y *
                          Math.sin(0.825 * n + l * (P * m + R * A)))));
                    var k = I - M,
                      N = X - F,
                      O = Math.cos(D),
                      W = Math.sin(D);
                    if (
                      ...
                      var Q =
                        this.blendPattern.vertInfoA[x / 2] *
                          this.blendProgress +
                        this.blendPattern.vertInfoC[x / 2];
                      ((Q = Math.clamp(Q, 0, 1)),
                        (this.warpUVs[x] = this.warpUVs[x] * Q + I * (1 - Q)),
                        (this.warpUVs[x + 1] =
                          this.warpUVs[x + 1] * Q + X * (1 - Q)),
                        (this.warpColor[b + 0] = 1),
                        (this.warpColor[b + 1] = 1),
                        (this.warpColor[b + 2] = 1),
                        (this.warpColor[b + 3] = Q));
                    } else
                      ((this.warpUVs[x] = I),
                        (this.warpUVs[x + 1] = X),
                        (this.warpColor[b + 0] = 1),
            ...
            },
            {
              ...
              value: function () {
                ...
                var a = {
                  ...
                  h = Object.assign({}, a);
                ((h.gmegabuf = this.prevPresetEquationRunner.gmegabuf),
                  (a.gmegabuf = this.presetEquationRunner.gmegabuf),
                  Object.assign(a, this.regVars),
                  this.presetEquationRunner.runFrameEquations(a));
                var o,
                  n = this.presetEquationRunner.mdVSFrame;
                (this.runPixelEquations(
                  this.presetEquationRunner.preset,
                  n,
                  ...
                  Object.assign(
                    this.regVars,
                    c.pick(this.mdVSVertex, this.regs),
                  ),
                  Object.assign(a, this.regVars),
                  this.blending
                    ? (this.prevPresetEquationRunner.runFrameEquations(h),
                      this.runPixelEquations(
                        this.prevPresetEquationRunner.preset,
                        this.prevPresetEquationRunner.mdVSFrame,
                        this.prevPresetEquationRunner.runVertEQs,
                        !0,
                      ),
                      (o = t.mixFrameEquations(
                        this.blendProgress,
                        n,
                        this.prevPresetEquationRunner.mdVSFrame,
                      )))
                    : (o = n)); /* [MW-PATCH: frame-rate normalization] */
                var _r = 30 / this.fps;
                if (_r < 0.99 || _r > 1.01) {
                  o.decay = Math.pow(o.decay, _r);
                  var _oa = 1 - Math.pow(1 - o.ob_a, _r);
                  o.ob_a = _oa < 0 ? 0 : _oa > 1 ? 1 : _oa;
                  var _ia = 1 - Math.pow(1 - o.ib_a, _r);
                  o.ib_a = _ia < 0 ? 0 : _ia > 1 ? 1 : _ia;
                  var _ma = 1 - Math.pow(1 - o.mv_a, _r);
                  o.mv_a = _ma < 0 ? 0 : _ma > 1 ? 1 : _ma;
                  var _ea = 1 - Math.pow(1 - o.echo_alpha, _r);
                  o.echo_alpha = _ea < 0 ? 0 : _ea > 1 ? 1 : _ea;
                }
                var l = this.targetTexture;
                ((this.targetTexture = this.prevTexture),
                  (this.prevTexture = l));
                var m = this.targetFrameBuffer;
                ((this.targetFrameBuffer = this.prevFrameBuffer),
                  (this.prevFrameBuffer = m),
                ...
                (this.blending
                  ...
                  this.motionVectors.drawMotionVectors(o, this.warpUVs),
                  this.preset.shapes &&
                    this.preset.shapes.length > 0 &&
                    this.customShapes.forEach(function (t, i) {
                      t.drawCustomShape(
                        e.blending ? e.blendProgress : 1,
                        a,
                        e.presetEquationRunner,
                        e.preset.shapes[i],
                        e.prevTexture,
                      );
                    }),
                  this.preset.waves &&
                    ...
                    this.customWaveforms.forEach(function (t, i) {
                  ...
                  this.blending &&
                    (this.prevPreset.shapes &&
                      ...
                      this.prevCustomShapes.forEach(function (t, i) {
                        t.drawCustomShape(
                          1 - e.blendProgress,
                          h,
                          e.prevPresetEquationRunner,
                          e.prevPreset.shapes[i],
                          e.prevTexture,
                        );
                      }),
                    this.prevPreset.waves &&
                      this.prevPreset.waves.length > 0 &&
                      this.prevCustomWaveforms.forEach(function (t, i) {
                        t.drawCustomWaveform(
                          1 - e.blendProgress,
                          e.audio.timeArrayL,
                          e.audio.timeArrayR,
                  ...
                  this.darkenCenter.drawDarkenCenter(o));
                var f = [o.ob_r, o.ob_g, o.ob_b, o.ob_a];
                this.outerBorder.drawBorder(f, o.ob_size, 0);
                var d = [o.ib_r, o.ib_g, o.ib_b, o.ib_a];
                if (
                  (this.innerBorder.drawBorder(d, o.ib_size, o.ob_size),
                  this.supertext.startTime >= 0)
                ) {
                  var v =
                    (this.time - this.supertext.startTime) /
                    this.supertext.duration;
                  v >= 1 && this.titleText.renderTitle(v, !0, a);
                }
                ((this.globalVars = a),
                  (this.mdVSFrame = n),
                  (this.mdVSFrameMixed = o),
                  this.renderToScreen());
              },
            },
            {
              ...
              value: function () {
                ...
                if (
                  ...
                  var r =
                    (this.time - this.supertext.startTime) /
                    this.supertext.duration;
                  (this.titleText.renderTitle(r, !1, this.globalVars),
                    r >= 1 && (this.supertext.startTime = -1));
                }
                this.outputFXAA &&
            ...
            },
            {
              ...
              value: function () {
                ...
                var l = n.getContext('2d'),
                  m = l.createImageData(this.texsizeX, this.texsizeY);
                return (
                  m.data.set(i),
                  l.putImageData(m, 0, 0),
                  this.gl.deleteTexture(r),
                  this.gl.deleteFramebuffer(s),
                  n.toDataURL()
                );
              },
            },
      ...
      var at = (function () {
        function t(e, i, s) {
          ...
          ((this.baseValsDefaults = {
            ...
            (this.renderer = new st(r, this.audio, s)));
        }
        var e, i, s;
        return (
          (e = t),
              ...
              value: function (t) {
                var e =
                    arguments.length > 1 && void 0 !== arguments[1]
                      ...
                      : 0,
                  i = Object.assign({}, t);
                i.baseVals = Object.assign(
                  {},
                  this.baseValsDefaults,
                  i.baseVals,
                );
                for (var s = 0; s < i.shapes.length; s++)
                  i.shapes[s].baseVals = Object.assign(
                    {},
                    this.shapeBaseValsDefaults,
                    i.shapes[s].baseVals,
                  );
                for (var r = 0; r < i.waves.length; r++)
                  i.waves[r].baseVals = Object.assign(
                    {},
                    this.waveBaseValsDefaults,
                    i.waves[r].baseVals,
                  );
                if ('function' != typeof i.init_eqs) {
                  ((i.init_eqs = new Function(
                    'a',
                    ''.concat(i.init_eqs_str, ' return a;'),
                  )),
                    (i.frame_eqs = new Function(
                      'a',
                      ''.concat(i.frame_eqs_str, ' return a;'),
                    )),
                    i.pixel_eqs_str && '' !== i.pixel_eqs_str
                      ? (i.pixel_eqs = new Function(
                          'a',
                          ''.concat(i.pixel_eqs_str, ' return a;'),
                        ))
                      : (i.pixel_eqs = ''));
                  for (var a = 0; a < i.shapes.length; a++)
                    0 !== i.shapes[a].baseVals.enabled &&
                      (i.shapes[a] = Object.assign({}, i.shapes[a], {
                        init_eqs: new Function(
                          'a',
                          ''.concat(i.shapes[a].init_eqs_str, ' return a;'),
                        ),
                        frame_eqs: new Function(
                          'a',
                          ''.concat(i.shapes[a].frame_eqs_str, ' return a;'),
                        ),
                      }));
                  for (var h = 0; h < i.waves.length; h++)
                    if (0 !== i.waves[h].baseVals.enabled) {
                      var o = {
                        init_eqs: new Function(
                          'a',
                          ''.concat(i.waves[h].init_eqs_str, ' return a;'),
                        ),
                        frame_eqs: new Function(
                          'a',
                          ''.concat(i.waves[h].frame_eqs_str, ' return a;'),
                        ),
                      };
                      (i.waves[h].point_eqs_str &&
                      '' !== i.waves[h].point_eqs_str
                        ? (o.point_eqs = new Function(
                            'a',
                            ''.concat(i.waves[h].point_eqs_str, ' return a;'),
                          ))
                        : (o.point_eqs = ''),
                        (i.waves[h] = Object.assign({}, i.waves[h], o)));
                    }
                }
