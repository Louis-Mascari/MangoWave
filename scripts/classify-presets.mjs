...
if (process.argv.includes('--update')) {
  ...
  // Note: MilkDrop preset names are tracked at runtime via VisualizerRenderer._milkdropPresetNames,
  // populated from the milkdrop-presets package. No static set needed here.
